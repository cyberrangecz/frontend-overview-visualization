...
import { Axis, BrushBehavior, D3, D3Service, Line, ScaleLinear, ScaleOrdinal, ZoomBehavior } from '@crczp/d3-service';
    ...
    load(): void {
        ...
        this.timelineService
            ...
            .subscribe((res) => {
                ...
                this.players = this.timelineData.timeline.playerData;
                this.redraw();
                if (TraineeModeInfo.isTrainee(this.traineeModeInfo) && !this.standalone) {
